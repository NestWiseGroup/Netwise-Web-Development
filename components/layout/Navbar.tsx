  ...
  return (
    <header className="sticky top-0 z-50 bg-[#1E3A8A] border-b border-[#B8860B]/30 shadow-lg transition-all">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 h-20 sm:h-24 flex items-center justify-between">
        ...
        {/* Desktop Navigation Links: How we Work, FAQ, About */}
        ...
        <div className="hidden sm:flex items-center gap-5">
          ...
          <a
            href="tel:+14254146819"
            className="btn-gold px-5 sm:px-6 py-3 rounded-xl text-xs sm:text-sm font-serif font-bold tracking-wide flex items-center gap-2 uppercase shadow-md border border-white/15 hover:shadow-gold-glow transition-all"
          >
      ...
      {mobileMenuOpen && (
        <div className="md:hidden bg-[#0A132C] border-b border-[#B8860B]/30 px-5 pt-4 pb-6 space-y-4 shadow-2xl animate-in fade-in slide-in-from-top-2 duration-200 text-white">
          ...
          <div className="pt-3 border-t border-white/10 flex flex-col gap-3">
            ...
            >
              <Phone className="w-4 h-4" />
              <span>Book a Strategy Call: (425) 414-6819</span>
            </a>
          </div>
        </div>
      )}
